...
import { FieldDefinition } from '@/types/field2';
...
export default function CreateItemModal2({
  isOpen,
  onClose,
  onItemCreated,
  collectionId,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Failed to create item in items2:', err);
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              {initialParentId
                ...
                : collectionId === null
                ? 'Creating an independent item outside of any collection folder'
...
export const CreateItemModal = CreateItemModal2;