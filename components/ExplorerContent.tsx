 ...
 * @property unifiedForest - Hierarchical tree data combining folders and their nested items
 * @property searchQuery - Filter string supplied from the parent LeftSidePanel search bar
 * @property activeCollectionId - ID of the currently selected collection folder
 * @property selectedItemId - ID of the currently active item record displayed in MainContent
 ...
 * @property onSelectItem - Callback selecting an item and populating the main stage canvas
 ...
 * Preserves ancestor chain if any descendant record matches the search criteria.
 */
function filterItem(
  item: ItemRecord,
  query: string
