...
import { ResetWidthRightIcon } from '@/components/icons/SystemIcons';
...
export default function RightPanel({
  ...
  return (
    <>
      ...
      >
        {/* 
          Left-Edge Seam Resize Handle (Isolated to vertical center):
          Enables custom panel width resizing without blocking the upper/lower scrollbars.
        */}
        {isOpen && (
          <div
            onPointerDown={handlePointerDown}
            onDoubleClick={handleResetWidth}
            className={`panel-resize-handle absolute top-1/2 -translate-y-1/2 -left-2 w-4 h-32 select-none group/resize ${
