...
/* ==========================================================================
   ...
   keeping app/page.tsx decoupled from modal imports and mounting logic.
   ========================================================================== */
  ...
  return (
    <>
      ...
      {/* --------------------------------------------------------------------
          ...
          Instantiates a new record under the designated collection or parent item.
          Filters allItems to supply sibling/parent relationships within scope.
          -------------------------------------------------------------------- */}
      ...
      {/* --------------------------------------------------------------------
          ...
          record is currently active in ItemDetailView before resyncing.
          -------------------------------------------------------------------- */}
