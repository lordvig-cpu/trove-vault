...
export default function BottomBar({
  ...
  return (
    <footer className="h-14 shrink-0 bg-surface/90 backdrop-blur-md border-t border-border-subtle px-4 flex items-center justify-between relative z-20 select-none">
      {/* Left Status Area */}
