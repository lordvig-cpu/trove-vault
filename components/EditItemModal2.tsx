...
import { FieldDefinition, CollectionTemplate } from './TemplateManagerModal2';
...
export default function EditItemModal2({
  isOpen,
  onClose,
  onItemUpdated,
  item,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Update error on items2:', err);
...
export const EditItemModal = EditItemModal2;