...
/**
 * Props for the NavigationFooter2 status bar.
...
/* ==========================================================================
   2. MAIN COMPONENT: NavigationFooter2
...
export default function NavigationFooter2({
  ...
  /* ------------------------------------------------------------------------
     ...
     Consumes persisted UI toggles and themes directly from UIPreferencesContext2.
     ------------------------------------------------------------------------ */
  const {
    animationsEnabled,
    toggleAnimations,
...
export const NavigationFooter = NavigationFooter2;