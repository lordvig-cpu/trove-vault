...
/**
 * Props for UnifiedExplorerTree recursive hierarchy.
 */
...
/* ==========================================================================
   ...
   Encapsulates coordinate calculation, hover bridges, and escape dismissals
   so folder and item rows don't duplicate coordinate math.
   ========================================================================== */
...
function useActionMenuLifecycle() {
  ...
  const handleGearMouseEnter = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    const menuHeight = 220; // Approximate action menu height
    const bottomNavReserve = 64; // Reserve boundary for bottom status bar
  ...
  const handleMouseLeave = () => {
    // If currently typing in the inline rename form, do not auto-close on mouse leave
...
/* ==========================================================================
   4. MAIN COMPONENT: UnifiedExplorerTree (Collection / Folder Root)
   ========================================================================== */
...
export default function UnifiedExplorerTree({
  ...
  // Expansion control: checks explicit external expandedFolderIds set or defaults open
  ...
  // VS Code style sticky sub-tier calculation
