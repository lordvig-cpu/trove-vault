...
export default function Navbar({
  ...
  return (
    <header className="h-14 border-b border-border-subtle bg-surface/90 backdrop-blur-md shadow-[0_1px_0_0_var(--bg-surface-hover),0_2px_0_0_var(--accent-primary)] flex items-center justify-between shrink-0 z-40 relative">
